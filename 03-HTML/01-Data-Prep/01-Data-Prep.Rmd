...
ts_signature <- ts_index %>% 
  ...
  # Get rid of weekends
  filter(wday_label %in% c("Mon", "Tue", "Wed", "Thu", "Fri"))
```

```{r}
ts_signature %>% distinct(second)
```
...
Next, we need to pad the time series to fill in the gaps. We will use the nearest price to fill the data for a 1-minute grid.
